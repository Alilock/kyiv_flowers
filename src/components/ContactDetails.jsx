    ...
    return (
        <div className='grid grid-cols-2 max-lg:grid-cols-1 h-[720px]'>
            <div className='order-1 max-lg:order-2 border-r border-[#121212]'>
                ...
                <div className='grid grid-cols-2 max-md:grid-cols-1 h-[360px]'>
                    <div>
            ...
            <div className='order-2 max-lg:order-1 border-r border-[#121212] lg:h-[720px] md:h-[580px]'>
                <img src={LuxeBouquets} alt="" className='h-full w-full' />
            </div>
